...
const botaoCriarQuadro2 = document.querySelector("#criar-novo-quadro2");
console.log("botao:", botaoCriarQuadro2)
botaoCriarQuadro.addEventListener("click", criarQuadro2);
